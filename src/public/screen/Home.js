...
import {Container, Content, View, Text, Title, Left, Right, Item, Icon, Header, Thumbnail, Body, Input, Card, CardItem } from 'native-base';
...
class Home extends Component {
  ...
  fetchDataNotes = () =>{ //Get data from action adn setState
    this.setState({
      page:1,
      refreshing: false,
    })
  ...
  fetchDataCategory = () =>{ //Get data from action category
    this.props.dispatch(getCategory())
  }
  
  componentDidMount = () => { //Mount data Or  get data after render 
      this.fetchDataNotes();
  ...
  ListEmpty = () => {
    return (
      <View style={styles.MainContainer}>
        <Text style={{ alignSelf: 'center', flex:1 }}>No Data Found</Text>
      </View>
    );
  };
